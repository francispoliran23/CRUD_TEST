...
@app.route("/user/get/<id><name><price><description><category>", methods=["GET"])
def user_get_controller(id,name, price, description, category):
    return object.user_get_model(id, name, price, description, category)
